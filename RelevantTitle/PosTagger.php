...
class PosTagger {
	/*  
	   The code here draws from the (many!) implementations of the Brill tagger by Mark Watson in various languages.
	   http://phpir.com/part-of-speech-tagging/ 
	   https://github.com/mark-watson/fasttag_v2
	   These are open source under MIT or GPL3 license or public domain
	*/
        private $dict; 
