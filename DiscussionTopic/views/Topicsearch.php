...
if ($FreeForm) {
    $Label = t('Enter free form discussion title to search for similar topics');
}
...
echo $this->Form->button(t('Search by subject'), array('type' => 'submit','name' => 'FreeFormSearch','onClick' => "CloseAndRefresh()"));
