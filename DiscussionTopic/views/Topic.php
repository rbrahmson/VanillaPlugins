...
if ($DefaultTopic != '' & $ModeName != 'Manual') echo $this->Form->button(t('Generate'), array('type' => 'submit', 'name' => 'Generate'));
if ($Topic != "") echo $this->Form->button(t('Remove'));
